         ...
         <tr>
            <td colspan="8" align="center" style="width:40vw">
               <form action="https://formsubmit.co/gonzavale25@gmail.com" method="POST">
                        ...
                        <br>
                        Consulta 
                        <textarea class="form-control" name="message" id="" cols="30" rows="10" placeholder="Escriba su consulta" required></textarea>
                        <br>
            ...
            <td colspan="12" align="center">
               ...
               style="border:0; width:60vw; height: 40vw;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </td>
         </tr>
         <tr>
            ...
            <td><img src="/imagenes/tl.png" style="width:3.5vw; height: 3.5vw; border-radius: 50px;"></td>
            <td><a class=" oo" href="#">939459100</a></td>
         </tr>
